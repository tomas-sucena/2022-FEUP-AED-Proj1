...
Helpy::Helpy(vector<Student> &students, vector<UC> &UCs, vector<Class> &classes,
             map<string, list<Block>> &c_blocks, map<string, list<Block>> &u_blocks) : all_students(students), all_UCs(UCs), all_classes(classes),
                                                                                       class_blocks(c_blocks), uc_blocks(u_blocks) {}

/**
 * @brief function that allows the user to choose the UI mode
 * complexity = n^2
 */
void Helpy::terminal()
{
...
b1:
    cout << endl
         << YELLOW << BREAK << RESET << endl;
    cout << endl
         << "How can I be of assistance?" << endl;
...
b2:
    cout << endl
         << YELLOW << BREAK << RESET << endl;
    cout << endl
         << "Hello! How can I be of assistance?" << endl;
    cout << endl;
    cout << "* Display" << endl;
    cout << "* Add" << endl;
    cout << "* Remove" << endl;
    ...
    else if (command[s1] == 200 && s2 == "student")
    { // s1 -> add
        cout << endl
             << YELLOW << BREAK << RESET << endl
             << endl;
    ...
    else if (command[s1] == 100 && s2 == "student")
    { // s1 -> remove
        cout << endl
             << YELLOW << BREAK << RESET << endl
             << endl;
...
bool Helpy::process_command(string &s1, string &s2, string &s3)
{
    ...
    default:
    {
        cout << endl
             << YELLOW << BREAK << RESET << endl;
        cout << endl
             << RED << "Invalid command! Please, type another command." << RESET << endl;
    ...
    for (UC u : all_UCs)
    {
        if (u.get_ucCode() == ucCode)
        {
            cout << endl
                 << YELLOW << BREAK << RESET << endl
                 << endl;
            cout << "The UC " << BOLD << ucCode << RESET << " has the following students:" << endl
                 << endl;
...
a10:
    cout << endl
         << YELLOW << BREAK << RESET << endl;
    cout << endl
         << "Please write the code (upXXXXXXXXX) or the name of the desired student." << endl;
...
a12:
    cout << endl
         << YELLOW << BREAK << RESET << endl
         << endl;
    cout << "What classes would you like to see?" << endl
         << endl;
    cout << "* All" << endl;
    ...
    while (line_ >> temp)
    {
        if (temp == "all")
        {
            cout << endl
                 << YELLOW << BREAK << RESET << endl
                 << endl;
            cout << "The classes are the following:" << endl
                 << endl;
...
a13:
    cout << endl
         ...
         << endl;
    cout << endl
         << "What UCs would you like to see?" << endl
         << endl;
    cout << "* All" << endl;
    cout << "* First Year" << endl;
    cout << "* Second Year" << endl;
    ...
    while (line_ >> temp)
    {
        if (temp == "all")
        {
            cout << endl
                 << YELLOW << BREAK << RESET << endl
                 << endl;
            cout << "The UCs are the following:" << endl
                 << endl;
...
a16:
    ...
    cout << endl
         << YELLOW << BREAK << RESET << endl
         << endl;
    (filter) ? (cout << "These are all the students that meet your criteria:") : (cout << "These are all the students currently enrolled in LEIC:");
    cout << endl
         << endl;
...
a20:
    ...
    cout << endl
         << "Please type the code (upXXXXXXXXX) or the name of the desired student" << endl;
    ...
    cout << endl
         << YELLOW << BREAK << RESET << endl;
    cout << endl
         << "Please type the code of the class you want to remove" << endl;
    string cl;
    cin >> cl;
    lowercase(cl, true);
...
a21:
    ...
    cout << endl
         << YELLOW << BREAK << RESET << endl;
    cout << endl
         << "Please type the code of the UC you want to remove" << endl;
    string uc;
    cin >> uc;
    lowercase(uc, true);
...
a22:
    ...
    cout << endl
         << YELLOW << BREAK << RESET << endl;
    cout << endl
         << "Please type the code of the UC you want to add" << endl;
    string cl;
    cin >> cl;
    lowercase(cl, true);
    ...
    cout << endl
         << YELLOW << BREAK << RESET << endl;
    cout << endl
         << "Please type the code of the class you want to add the UC to" << endl;
    string f;
    cin >> f;
    lowercase(f, true);
            ...
            if (s.get_studentCode() == sub.get_student())
            {
                ...
                if (s.remove_class(sub.get_class()) > 0)
                {
                    ...
                    for (auto it = a.begin(); it != a.end();)
                    {
                        ...
                        {
                            int num = (it->first[0] == 'L') ? (int)(it->first[6] - '0') * 5 + (it->first[7] - '0') - 1 : (int)all_UCs.size() - 1;
    ...
    for (string uc : ucs)
    {
        ...
        for (auto cla = sub.begin(); cla != sub.end(); cla++)
        {
            ...
            for (auto pain = sub.begin(); pain != sub.end(); pain++)
            {
                ...
                nu = ((*pain)[5] - '0') * 10 + ((*pain)[6] - '0');
                Class &o = all_classes[(year - 1) * 16 + (nu - 1)];
                dif = (&g == &c) ? abs(int(g.get_occupation()[uc].size() - o.get_occupation()[uc].size())) + 1 : abs(int(g.get_occupation()[uc].size() - o.get_occupation()[uc].size()));
                if (&g == &c)
                {
                    cout << "Same" << endl;
                }
